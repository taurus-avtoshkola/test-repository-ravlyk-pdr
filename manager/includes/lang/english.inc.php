...
$_lang['enable_mootools_message'] = 'Load Mootools.js in manager for backward compatibility';
 ...
 $_lang["shop_finish"] = "Ready";
 $_lang["shop_management"] = "Shop Manager";
 $_lang["shop_orders"] = "Orders";
 $_lang["shop_order"] = "Order";
 $_lang["shop_order_r"] = "Order";
 $_lang["shop_products"] = "Goods";
 $_lang["shop_product"] = "Goods";
 $_lang["shop_filters"] = "Filters";
 $_lang["shop_import"] = "Import";
 $_lang["shop_import_progress"] = "Is the import of goods...";
 $_lang["shop_export"] = "Export";
 $_lang["shop_export_r"] = "Export";
 $_lang["shop_date"] = "Date";
 $_lang["shop_client"] = "Client";
 $_lang["shop_cost"] = "Cost";
 $_lang["shop_status"] = "Status";
 $_lang["shop_payment"] = "Payment";
 $_lang["shop_sent"] = "Sent";
 $_lang["shop_new"] = "New";
 $_lang["shop_not_paid"] = "Not paid";
 $_lang["shop_paid"] = "Paid";
 $_lang["shop_details"] = "Details";
 $_lang["shop_name"] = "Name";
 $_lang["shop_price"] = "Price";
 $_lang["shop_price_p"] = "Separator point";
 $_lang["shop_availability"] = "Availability";
 $_lang["shop_available"] = "Available";
 $_lang["shop_not_available"] = "Not available";
 $_lang["shop_bestseller"] = "Hit of sales";
 $_lang["shop_promotional"] = "Promo";
 $_lang["shop_edit"] = "Edit";
 $_lang["shop_delete"] = "Delete";
 $_lang["shop_search_by"] = "Search by id, product name, url";
 $_lang["shop_on_request"] = "On request";
 $_lang["shop_not_found"] = "nothing is found";
 $_lang["shop_visible"] = "visible";
 $_lang["shop_not_visible"] = "not visible";
 $_lang["shop_new_product"] = "Add item";
 $_lang["shop_new_filter"] = "Add filter";
 $_lang["shop_type"] = "Type";
 $_lang["shop_import_csv"] = "Imports CSV";
 $_lang["shop_import_to_site"] = "Import data about the products on the website";
 $_lang["shop_load_csv"] = "Download the CSV file";
 $_lang["shop_import_r"] = "To import";
 $_lang["shop_import_xml"] = "Imports of goods XML";
 $_lang["shop_load_xml"] = "Download the XML file(via a form or FTP) and the folder with the images of products (by default /assets/import/)";
 $_lang["shop_export_orders"] = "Export orders";
 $_lang["shop_export_i"] = "Export data about orders for the selected period in the file. Perhaps filtering by the status of the order";
 $_lang["shop_from"] = "C";
 $_lang["shop_to"] = "on";
 $_lang["shop_deleted"] = "Deleted";
 $_lang["shop_all"] = "All";
 $_lang["shop_delivered"] = "Delivered";
 $_lang["shop_edit_product"] = "Editing goods";
 $_lang["shop_view_product_page"] = "The view page of goods";
 $_lang["shop_update_product"] = "To update the product";
 $_lang["shop_texts"] = "Texts";
 $_lang["shop_url_product"] = "the url of the page of the goods";
 $_lang["shop_product_code"] = "Code";
 $_lang["shop_product_code_p"] = "Definitely a unique value!";
 $_lang["shop_yes"] = "Yes";
 $_lang["shop_no"] = "No";
 $_lang["shop_categories"] = "Categories";
 $_lang["shop_categories_p"] = "Select the categories to which is attached the goods";
 $_lang["shop_images"] = "Image";
 $_lang["shop_load_images"] = "Download image";
 $_lang["shop_images_delete"] = "To delete the image";
 $_lang["shop_set_cover"] = "To make the cover of the goods";
 $_lang["shop_file_format"] = "Nepravilni file format!";
 $_lang["shop_cancel"] = "Cancel";
 $_lang["shop_product_name"] = "Name of goods";
 $_lang["shop_introtext"] = "Annotation";
 $_lang["shop_description"] = "Description";
 $_lang["shop_value"] = "Value";
 $_lang["shop_filter_name"] = "Filter name";
 $_lang["shop_filter_edit"] = "Editing filter";
 $_lang["shop_filter_save"] = "Save filter";
 $_lang["shop_filter_add"] = "Add filter";
 $_lang["shop_filter_update"] = "To update the filter";
 $_lang["shop_filter_ask"] = "Besides the filter will be removed, all values for all products related to it.\nYou deisvitelno want to delete this filter?";
 $_lang["shop_filter_desc"] = "The description of the filter";
 $_lang["shop_filter_type"] = "Filter type";
 $_lang["shop_filter_i"] = "The filters will be available after saving product";
 $_lang["shop_numerical"] = "Numerical";
 $_lang["shop_or"] = "OR";
 $_lang["shop_and"] = "And";
 $_lang["shop_bind_category"] = "To link to a category";
 $_lang["shop_bind_category_p"] = "Select the categories for linking filter to them";
 $_lang["shop_settings"] = "Tuning shop";
 $_lang["shop_common"] = "General";
 $_lang["shop_page_item"] = "The product page";
 $_lang["shop_page_item_i"] = "The ID of the page stub which has a template of the goods";
 $_lang["shop_tpl_category"] = "Template catalog of goods";
 $_lang["shop_tpl_category_i"] = "Pages with this template can be used to attach the goods";
 $_lang["shop_catalog_root"] = "The directory root";
 $_lang["shop_get_keys"] = "Get the keys";
 $_lang["shop_save_settings"] = "Save settings";
 $_lang["shop_currencies"] = "Exchange";
 $_lang["shop_currency_name"] = "Currency name";
 $_lang["shop_internal_id"] = "The internal identifier";
 $_lang["shop_internal_id_i"] = "It will be identified as the currency in scripts";
 $_lang["shop_currency_sign"] = "Currency symbol";
 $_lang["shop_currency_sign_i"] = "Displayed on the website anywhere near the rates";
 $_lang["shop_currency"] = "Exchange rate";
 $_lang["shop_currency_i"] = "How to multiply the base currency";
 $_lang["shop_summary"] = "Main";
 $_lang["shop_currency_delete"] = "Delete currency";
 $_lang["shop_delivery"] = "Shipping";
 $_lang["shop_delivery_name"] = "The name of the shipping method exchange";
 $_lang["shop_delivery_cost"] = "Shipping cost";
 $_lang["shop_default"] = "Default";
 $_lang["shop_delivery_delete"] = "Remove the shipping method";
 $_lang["shop_mail_tpls"] = "Email templates";
 $_lang["shop_new_mail_tpl"] = "To add an email template";
 $_lang["shop_edit_meta_tpl"] = "Edit META-template";
 $_lang["shop_meta_tpl"] = "META-template";
 $_lang["shop_common_meta_tpl"] = "General meta-template";
 $_lang["shop_add_meta_tpl"] = "Create order meta-template";
 $_lang["shop_order_meta_tpl"] = "Template creation order (meta)";
 $_lang["shop_order_product_tpl"] = "Template of order creation (product)";
 $_lang["shop_change_status_tpl"] = "The pattern of changing the status of the order";
 $_lang["shop_registration_tpl"] = "The pattern of registration on the website";
 $_lang["shop_add_order_tpl"] = "The creation order";
 $_lang["shop_recover_pass_tpl"] = "Template password recovery";
 $_lang["shop_change_status"] = "The order status change";
 $_lang["shop_registration"] = "Registration on the site";
 $_lang["shop_recover_pass"] = "Password recovery";
 $_lang["shop_available_tpls"] = "Available templates";
 $_lang["shop_name_tpl"] = "The name of the template";
 $_lang["shop_id_tpl"] = "The ID of the template";
 $_lang["shop_edit_tpl"] = "Edit your template";
 $_lang["shop_version_lang"] = "Version for the language";
 $_lang["shop_mail_subject_p"] = "Subject";
 $_lang["shop_mail_main_p"] = "The content of the template";
 $_lang["shop_mail_i"] = "In a META-template necessary to predetermine placeholder";
 $_lang["shop_mail_i2"] = "which will be replaced by the contents of the embedded subpattern";
 $_lang["shop_save_tpl"] = "Save template";
 $_lang["shop_payment_system"] = "Payment systems";
 $_lang["shop_payments"] = "payment";
 $_lang["shop_import_dir"] = "The original import folder";
 $_lang["shop_import_dir_i"] = "The path to the source folder of import";
 $_lang["shop_import_filename"] = "The name of the file to import";
 $_lang["shop_import_filename_i"] = "The name of the .xml";
 $_lang["shop_img_dir_from"] = "The source folder for images";
 $_lang["shop_img_dir_from_i"] = "The path to the folder from where to import pictures";
 $_lang["shop_img_dir_to"] = "Destination folder for images";
 $_lang["shop_img_dir_to_i"] = "The path to the folder where to import pictures";
 $_lang["shop_import_step"] = "The threshold import processing";
 $_lang["shop_import_step_i"] = "The number of goods that will be imported in one iteration. 0 is the whole file at one time.";
 $_lang["shop_export_dir"] = "The source folder export";
 $_lang["shop_export_dir_i"] = "The path to the source folder export";
 $_lang["shop_export_filename"] = "The name of the export file";
 $_lang["shop_export_filename_i"] = "The name of the .xml";
 $_lang["shop_export_period"] = "The period of export";
 $_lang["shop_export_period_i"] = "The period of export standard";
 $_lang["shop_period_m"] = "For 1 month";
 $_lang["shop_period_w"] = "1 week";
 $_lang["shop_period_d"] = "Per 1 day";
 $_lang["shop_period_all"] = "For the whole period";
 $_lang["shop_item_added"] = "The product is successfully added to the database";
 $_lang["shop_item_updated"] = "The product is successfully updated";
 $_lang["shop_payments_updated"] = "The data for systems of payments updated";
 $_lang["shop_updated"] = "updated";
 $_lang["shop_import_error_xml"] = "Error! Download the correct XML file!";
 $_lang["shop_import_error_csv"] = "Error! Download the correct CSV file!";
 $_lang["shop_import_ok"] = "All data is imported successfully!";
 $_lang["shop_export_ok"] = "All data is exported successfully!";
 $_lang["shop_currency_updated"] = "The updated list of currencies";
 $_lang["shop_templates_updated"] = "Email templates updated";
 $_lang["shop_imex_updated"] = "Settings import/export updated";
 $_lang["shop_fio"] = "Full name";
 $_lang["shop_phone"] = "Telephone";
 $_lang["shop_manager"] = "Manager";
 $_lang["shop_pay"] = "Payment";
 $_lang["shop_client_comment"] = "Client comments";
 $_lang["shop_mode"] = "Way";
 $_lang["shop_zip"] = "Index";
 $_lang["shop_city"] = "City";
 $_lang["shop_street"] = "Street";
 $_lang["shop_home"] = "House";
 $_lang["shop_apartment"] = "Apartment";
 $_lang["shop_count"] = "Qty";
 $_lang["shop_product_to_order"] = "To add the goods in the order";
 $_lang["shop_total"] = "TOTAL";
 $_lang["shop_msg"] = "Notifications";
 $_lang["shop_msg_email"] = "Notify the client about the order status change by email";
 $_lang["shop_order_update"] = "To order update";
 $_lang["shop_order_delete"] = "Remove the goods from the order?";
 $_lang["shop_recalls"] = "Feedback";
 $_lang["shop_recall_name"] = "User name";
 $_lang["shop_recall_email"] = "Email user";
 $_lang["shop_recall_date"] = "Date of review";
 $_lang["shop_recall_moderated"] = "Status";
 $_lang["shop_pub"] = "Published";
 $_lang["shop_not_pub"] = "Not published";
 $_lang["shop_recall_edit"] = "Edit feedback";
 $_lang["shop_recall_text"] = "The text of the review";
 $_lang["shop_recall_update"] = "To update a review";
 $_lang["shop_recall_updated"] = "Feedback successfully saved";
 $_lang["shop_recall_deleted"] = "A review was deleted";
 $_lang["shop_filter"] = "Filter";
 $_lang["shop_product_friends"] = "Featured products";
 $_lang["shop_product_friends_p"] = "Comma separator";
 $_lang["shop_price_hotline"] = "Price aggregator hotline";
 $_lang["shop_price_pn"] = "Price aggregator pn.com.ua";
 $_lang["shop_price_filename"] = "File name";
 $_lang["shop_lang"] = "Language";
 $_lang["shop_hotline_filename_i"] = "hotline.xml";
 $_lang["shop_pn_filename_i"] = "pn.xml";
 $_lang["shop_lang_i"] = "The language of the locale in which to create the file";
 $_lang["shop_filter_deleted"] = "The filter is removed";

 $_lang["lang_translate_manager"] = "Managing translations";
 $_lang["lang_last_added"] = "20 last added";
 $_lang["lang_search"] = "Search the database of translations";
 $_lang["lang_not_found"] = "Nothing was found!";
 $_lang["lang_searching"] = "Yes searching, searching...";
 $_lang["lang_translated"] = "Translations";
 $_lang["lang_settings"] = "Settings";
 $_lang["lang_add"] = "Add";
 $_lang["lang_save"] = "Save";
 $_lang["lang_option"] = "option";
 $_lang["lang_add_i"] = "To add the output of the translation you want to display";
 $_lang["lang_add_i2"] = "line number";
 $_lang["lang_add_translate"] = "Add translation";
 $_lang["lang_multilang"] = "Multilanguage works?";
 $_lang["lang_list"] = "The list of languages";
 $_lang["lang_default"] = "The default language in";

 $_lang["mailer_server"] = "Server";
 $_lang["mailer_port"] = "Port";
 $_lang["mailer_login"] = "Login";
 $_lang["mailer_pass"] = "Password";
 $_lang["mailer_from"] = "Sender";
 $_lang["mailer_mail_cnt"] = "How many letters to send in one sitting";
 $_lang["mailer_save"] = "Save";
 $_lang["mailer_analitycs"] = "Statistics";
 $_lang["mailer_tpl"] = "Templates";
 $_lang["mailer_list_mail"] = "Mailing lists";
 $_lang["mailer_config"] = "Configuration";
 $_lang["mailer_name_tpl"] = "The name of the template";
 $_lang["mailer_date_tpl"] = "Date template creation";
 $_lang["mailer_mail_status"] = "Status distribution";
 $_lang["mailer_sents"] = "Sent";
 $_lang["mailer_remaining"] = "Remained";
 $_lang["mailer_mails"] = "letters";
 $_lang["mailer_tpl_i"] = "Here to store the HTML coding of the template:";
 $_lang["mailer_tpl_i2"] = "instead of the name of the addressee leave";
 $_lang["mailer_tpl_i3"] = "link to the unsubscribing from the list";
 $_lang["mailer_mail_tpl_name"] = "The name of the template and theme of letter";
 $_lang["mailer_tpl_i4"] = "wrap the element";
 $_lang["mailer_tpl_i5"] = "to expand the abbreviation";
 $_lang["mailer_add_tpl"] = "To create a template distribution";
 $_lang["mailer_theme_mail"] = "the topic of the mailing list";
 $_lang["mailer_edit"] = "Edit";
 $_lang["mailer_delete"] = "Delete";
 $_lang["mailer_import_users"] = "Import from a list of web users";
 $_lang["mailer_name"] = "Name";
 $_lang["mailer_del_user"] = "Remove from list";
 $_lang["mailer_added_tpl"] = "The template was added";
 $_lang["mailer_update_tpl"] = "The template is updated";
 $_lang["mailer_del_tpl"] = "The template is removed";
 $_lang["mailer_update_conf"] = "Configuration upgraded successfully!";
 $_lang["mailer_del_user_i"] = "The user is removed from the mailing list";

 $_lang["seo_add_redirect"] = "Add redirection";
 $_lang["seo_update"] = "Update";
 $_lang["seo_delete"] = "Delete";
 $_lang["seo_code_redirect"] = "Redirect code";
 $_lang["seo_redirect_from"] = "Redirect from";
 $_lang["seo_on"] = "on";
 $_lang["seo_cancel"] = "Cancel";
 $_lang["seo_redirects"] = "Redirect";
 $_lang["seo_site_map"] = "Site map";
 $_lang["seo_counters"] = "Counters";
 $_lang["seo_yandex_metric"] = "Yandex Metric";
 $_lang["seo_save"] = "Save";
 $_lang["seo_update_file"] = "To update a file robots.txt";
 $_lang["seo_file"] = "File robots.txt";
 $_lang["seo_file_i"] = "this is a text file located in the root directory of the site, which is written special instructions for search engines. These instructions can prevent the indexing of certain sections or pages on the site to point to the correct \"mirroring\" domain, to recommend to the crawler to follow a certain time interval between downloading documents from the server, etc.";
 $_lang["seo_site_map_i"] = "Using the Sitemap webmasters can tell search engines web pages that are available for scanning. A Sitemap is an XML file that lists the URLS of the website in conjunction with the metadata associated with each URL (date it was last modified; the frequency of changes; his priority at the site)so that search engines can more intelligently scan this website.";
 $_lang["seo_update_site_map"] = "Update algorithm sitemap.xml";
 $_lang["seo_aloritm_updated"] = "The algorithm updated";
 $_lang["seo_file_updated"] = "File robots.txt updated";
 $_lang["seo_settings_updated"] = "Settings are updated!";

$_lang["shop_title_shop"] = 'Shop management';
$_lang["shop_title_settings"] = 'Shop configuration';