        ...
        <fieldset id="create_edit">
            ...
            <div class="sectionBody">
                ...
                <div class="tab-pane" id="documentPane">
                    ...
                    <? foreach ($languages as $lang): $language = ($modx->config['lang_enable'] ? "_".$lang : "");?>
                        <div class="tab-page" id="tabGeneral<?=$lang?>">
                            <h2 class="tab"><?php echo $_lang['settings_general']?> (<?=$lang?>)</h2>
                            <script type="text/javascript">tpSettings.addTabPage( document.getElementById( "tabGeneral<?=$lang?>" ) );</script>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input name="pagetitle<?=$language?>" type="text" maxlength="255" value="<?= $modx->getPhpCompat()->htmlspecialchars(stripslashes(get_by_key($content, 'pagetitle'.$language, '', 'is_scalar'))) ?>" class="inputBox" onchange="documentDirty=true;" spellcheck="true" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="longtitle<?=$language?>" type="text" maxlength="255" value="<?= $modx->getPhpCompat()->htmlspecialchars(stripslashes(get_by_key($content, 'longtitle'.$language, '', 'is_scalar'))) ?>" class="inputBox" onchange="documentDirty=true;" spellcheck="true" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input name="description<?=$language?>" type="text" maxlength="255" value="<?= $modx->getPhpCompat()->htmlspecialchars(stripslashes(get_by_key($content, 'description'.$language, '', 'is_scalar'))) ?>" class="inputBox" onchange="documentDirty=true;" spellcheck="true" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input name="link_attributes<?=$language?>" type="text" maxlength="255" value="<?= $modx->getPhpCompat()->htmlspecialchars(stripslashes(get_by_key($content, 'link_attributes'.$language, '', 'is_scalar')))?>" class="inputBox" onchange="documentDirty=true;" />
                                    </td>
                                </tr>
                                ...
                                <?php if($content['type'] == 'reference' || $modx->getManagerApi()->action == '72') { // Web Link specific ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input name="ta_<?=$lang?>" id="ta" type="text" maxlength="255" value="<?= (!empty($content['content_'.$lang]) ? entities(stripslashes($content['content_'.$lang]), $modx->getConfig('modx_charset')) : 'http://') ?>" class="inputBox" onchange="documentDirty=true;" /><input type="button" value="<?=ManagerTheme::getLexicon('insert');?>" onclick="BrowseFileServer('ta')" />
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        <textarea id="introtext<?=$language?>" name="introtext<?=$language?>" class="inputBox" rows="3" cols="" onchange="documentDirty=true;"><?= $modx->getPhpCompat()->htmlspecialchars(stripslashes(get_by_key($content, 'introtext'.$language, '', 'is_scalar'))) ?></textarea>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="menutitle<?=$language?>" type="text" maxlength="255" value="<?= $modx->getPhpCompat()->htmlspecialchars(stripslashes(get_by_key($content, 'menutitle'.$language, '', 'is_scalar'))) ?>" class="inputBox" onchange="documentDirty=true;" />
                                    </td>
                                </tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div id="content_body">
                                                ...
                                                if((!empty($content['richtext']) || $modx->getManagerApi()->action == '4') && $modx->getConfig('use_editor')) {
                                                    $htmlContent = get_by_key($content, 'content'.$language, '', 'is_scalar');
                                                    ?>
                                                    <div class="section-editor clearfix">
                                                        <textarea id="ta<?=$language?>" name="ta<?=$language?>" onchange="documentDirty=true;"><?= $modx->getPhpCompat()->htmlspecialchars($htmlContent) ?></textarea>
                                                    </div>
                                                    <?php
                                                    // Richtext-[*content*]
                                                    $richtexteditorIds[$editor][] = 'ta'.$language;
                                                    $richtexteditorOptions[$editor]['ta'.$language] = array();

                                                } else {
                                                    echo "\t" . '<div><textarea class="phptextarea" id="ta'.$language.'" name="ta" rows="20" wrap="soft" onchange="documentDirty=true;">', $modx->getPhpCompat()->htmlspecialchars(get_by_key($content, 'content'.$language, '')), '</textarea></div>' . "\n";
                                                }
                                                ?>
                                            </div>
                                        </td>
