<div class="tab-page <?php echo e($tabPageName); ?>" id="<?php echo e($tabIndexPageName); ?>">
    <h2 class="tab">
        <a href="?a=76&tab=<?php echo e($index); ?>"><i class="fa fa-cubes"></i> <?php echo e(ManagerTheme::getLexicon('modules')); ?></a>
    </h2>
            ...
            <div class="input-group input-group-sm">
                ...
                <div class="input-group-btn">
                    <?php if(evolutionCMS()->hasPermission('new_module') && evolutionCMS()->hasPermission('save_module')): ?>
                        <a class="btn btn-success" href="<?php echo e((new EvolutionCMS\Models\SiteModule)->makeUrl('actions.new')); ?>">
                ...
                <?php $__env->startComponent('manager::partials.panelCollapse', ['name' => $tabIndexPageName . '_content', 'id' => 0, 'title' => ManagerTheme::getLexicon('no_category')]); ?>
                    <ul class="elements">
                        <?php $__currentLoopData = $outCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('manager::page.resources.elements.module', compact('item', 'tabIndexPageName', 'action'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
