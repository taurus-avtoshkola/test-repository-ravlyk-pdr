...
!function ($) {
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            {
                html += '<th class="prev available"><i class="glyphicon glyphicon glyphicon-arrow-left"></i></th>';
            }
            else
            {
                 html += '<th></th>';
            ...
            {
                html += '<th class="next available"><i class="glyphicon glyphicon glyphicon-arrow-right"></i></th>';
            }
            else
            {
                 html += '<th></th>';
