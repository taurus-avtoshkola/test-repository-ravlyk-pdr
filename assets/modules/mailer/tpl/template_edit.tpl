<form action="<?=$url?>&get=templates" method="post">
	...
	<input type="text" name="theme" class="theme" placeholder="Название шаблона и тема письма" title="Название шаблона и тема письма" autofocus class="span12" value="<?=$template['template_subject']?>">
	<br><br>
	<textarea name="post" class="span12" id="post_text"><?=$template['template_post']?></textarea>
	<p>&nbsp;</p>
