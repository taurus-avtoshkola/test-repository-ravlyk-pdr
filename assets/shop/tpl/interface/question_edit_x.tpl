<a href="<?=$url?>b=test&c=vidpovidi_x" class="btn btn-warning">Назад</a>
</br>

<form action="<?=$url?>b=test&c=update_x&i=<?=$_REQUEST['i']?>" method="POST">
	...
	<tbody>
		...
		<tr>				
			<td>Пункт ПДР</td>
			<td>
				<select name="pdr" name="name" class="form-control" data-active="<?=($question['pdr'])?>">
