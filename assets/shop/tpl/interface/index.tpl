...
.nav-justified{
  ...
  $('.fancybox').fancybox();
            ...
            $('.make-switch').bootstrapSwitch('setOnLabel', 'Так');
            $('.make-switch').bootstrapSwitch('setOffLabel', 'Ні');
  ...
  <div class="container col-xs-12">
    ...
    <div class="masthead">
      <ul class="nav nav-justified">
        ...
        <li <?=($_GET['b'] == "recalls" ? 'class="active"' : '')?>><a href="<?=$url?>b=recalls">Відгуки (інстр)</a></li>
        <li <?=($_GET['b'] == "recalls_content" ? 'class="active"' : '')?>><a href="<?=$url?>b=recalls_content">Відгуки</a></li>
        <li <?=($_GET['b'] == "telegram" ? 'class="active"' : '')?>><a href="<?=$url?>b=telegram">TG</a></li>
      </ul>
    </div>
    ...
    <div class="masthead">
      <ul class="nav nav-justified">
        ...
        <li <?=($_GET['b'] == "subscribers" ? 'class="active"' : '')?>><a href="<?=$url?>b=subscribers">Підписки</a></li>
        <li <?=($_GET['b'] == "webi" ? 'class="active"' : '')?>><a href="<?=$url?>b=webi">Вебінари</a></li>
        <li <?=($_GET['b'] == "master" ? 'class="active"' : '')?>><a href="<?=$url?>b=master">Майстер-клас</a></li>
        ...
        <li <?=($_GET['b'] == "call_instructor" ? 'class="active"' : '')?>><a href="<?=$url?>b=call_instructor">Практичні запит</a></li>
        <li <?=($_GET['b'] == "city_form" ? 'class="active"' : '')?>><a href="<?=$url?>b=city_form">Заявки міста</a></li>
        <li <?=($_GET['b'] == "chats" ? 'class="active"' : '')?>><a href="<?=$url?>b=chats">GPT</a></li>
        <li <?=($_GET['b'] == "items" ? 'class="active"' : '')?>><a href="<?=$url?>b=items">Товари</a></li>
        <li <?=($_GET['b'] == "promo" ? 'class="active"' : '')?>><a href="<?=$url?>b=promo">Promo</a></li>
      </ul>
    </div>
    <? endif ?>
    <? if (isset($_GET['w'])): ?>
