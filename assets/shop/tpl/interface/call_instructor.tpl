...
<table class="table table-condensed table-striped table-bordered table-hover">
	<thead>
		<tr>
			...
			<th>ID інстріктора <nobr><span class="ord" data-order="ORDER BY o.instructor_id DESC">&uarr;</span><span class="ord" data-order="ORDER BY o.instructor_id ASC">&darr;</span></nobr></th>
			<th>Ім`я інстріктора <nobr><span class="ord" data-order="ORDER BY o.instructor_name DESC">&uarr;</span><span class="ord" data-order="ORDER BY o.instructor_name ASC">&darr;</span></nobr></th>
	...
	<tbody>
		...
		?>
			<tr>
				...
				<td>
					<a data-confirm="Ви впевнені, що хочете видалити?" href="<?=$url?>b=call_insrtuctor&c=delete&i=<?=$pro['id']?>" class="btn btn-mini btn-danger"><span class="glyphicon glyphicon-remove-sign"></span> <?=$_lang["shop_delete"]?> </a>
				</td>
			</tr>
		<? endwhile;endif; ?>		
	</tbody>
