...
<form action="<?=$url?>b=recalls_content" method="post" enctype="multipart/form-data" class="pull-right">
	...
	<tbody>
		...
		?>
			<tr>				
				...
				<td>
					<a href="<?=$url?>b=recalls_content&c=edit&i=<?=$recall['recall_id']?>" class="btn btn-mini btn-primary"><span class="glyphicon glyphicon-edit"></span> Редагувати </a>
					<a data-confirm="Точно видалити?" href="<?=$url?>b=recalls_content&c=delete&i=<?=$recall['recall_id']?>" class="btn btn-mini btn-danger"><span class="glyphicon glyphicon-remove-sign"></span> Видалити</a>
				</td>
			</tr>
		<? endwhile;endif; ?>		
	</tbody>
