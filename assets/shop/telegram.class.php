...
if (!class_exists('Telegram')) {
  ...
  class Telegram  {
    ...
    var $from = 'PDR-ONLINE';
		var $avatar = 'https://pdr-online.com.ua/assets/templates/default/img/logo.png';
		var $token = '7334149341:AAFAZGJBiqyiB-44JrzZTyeU-dttuCqfGKQ';//'6911261249:AAFrguBPMSILbXnGVytHWjeJ1_gnnGdZGNs';
